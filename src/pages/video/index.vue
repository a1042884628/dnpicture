		...
		<view class="video_tab">
			<view class="video_tab_title">
				<view class="title_inner">
					<uni-segmented-control :values="items.map(v=>v.title)" :current="current" @clickItem="onClickItem" style-type="text"
			...
			<view class="video_tab_content">
				...
				<view v-if="current===4">
					<videoCategory :urlobj="{url:items[4].url,params:items[4].params}"></videoCategory>
				</view>
			</view>
		</view>
	</view>
		...
		data() {
			return {
				items: [{
					...
					{
						title: "分类",url:"http://service.picasso.adesk.com/v1/vertical/category",params:{}
					}
				],
				current: 0
			}
